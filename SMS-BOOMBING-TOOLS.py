...
\033[1;32m[-] AUTHOR    :\033[1;32m ABDUL MALEK 
\033[1;32m[-] GITHUB    :\033[1;32m AbdulMalek-OFFICIAL07
\033[1;32m[-] FACEBOOK  :\033[1;32m Ew'r Abdul Malek 
...
rp= 'ABDULLAH'
x = '143'
if 'ABDULLAH'==user and '143'==pas:
	Axak(g+"\n\n\t\t      LOGIN SUCCESSFUL JOIN MY FACEBOOK ACCOUNT ")
	os.system('xdg-open https://www.facebook.com/profile.php?id=100067336241100')
else:
	Axak(y+"\n\n\t\t      Invalid User Or Pass")
	Axak(y+"\n\n\t\tContract Admin For User And Pass")
	os.system("xdg-open https://wa.me/+8801627865142")
...
for i in range(amo):
	...
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥ABDUL MALEK🔥 "+w+tim)
